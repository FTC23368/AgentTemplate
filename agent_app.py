...
def start_chat(container=st):
    ...
    st.markdown("<h1 class='app-title' style='color: #87CEEB; font-size: 3.5rem;'>Agent X</h1>", unsafe_allow_html=True)
    st.markdown("<div class='section-title'>Your AI assistant.</div>", unsafe_allow_html=True)
